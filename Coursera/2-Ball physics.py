...
class Ball:
    def __init__(self, radius, color, domain):
        ...
        self.pos = self.domain.random_pos(self.radius)              # random position inside the radius
        self.vel = [random.random() + .1, random.random() + .1]     # random velocity with x and y component
